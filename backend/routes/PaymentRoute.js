...
router.post('/payment', async (req, res) => {
    ...
    try {
        ...
        const data = {
            ...
            currency: 'BDT',
            tran_id: tran_id,
            success_url: `http://aust-carnival-backend.vercel.app/api/success?tran_id=${tran_id}`,
            fail_url: `http://aust-carnival-backend.vercel.app/api/error/${tran_id}`,
            cancel_url: `http://aust-carnival-backend.vercel.app/api/error/${tran_id}`,
